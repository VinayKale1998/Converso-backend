...
import { addUser,newUser,getIndividualGroupUsers, users } from "./helpers/helper.js";
...
io.on("connection", (socket) => {
  ...
  socket.on("login", (data) => {
  ...
  else
    {
      ...
      socket.broadcast.to(user.group).emit("entered",{message:`${user.userName} has entered the chat`})
